...
public class ReflectionUtil {
    public static void parseParameter(Parameter[] parameter, ApiInfoDto.ApiInfoDtoBuilder builder) {
    ...
    public static Optional<ApiInfoDto.ApiInfoDtoBuilder> parseRequestAnnotation(Method method, Annotation annotation) {
        if (annotation instanceof GetMapping) {
            GetMapping getMapping = (GetMapping) annotation;
            return Optional.of(ApiInfoDto.builder()
